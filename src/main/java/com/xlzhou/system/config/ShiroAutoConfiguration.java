...
public class ShiroAutoConfiguration {
    ...
    /**
     * 创建凭证匹配器 获取加密方式 shiro配置加密算法
     */
    @Bean
    public HashedCredentialsMatcher hashedCredentialsMatcher(){
        System.out.println("进入ShiroAutoConfigurationr类hashedCredentialsMatcher方法");
    ...
    public UserRealm userRealm(CredentialsMatcher credentialsMatcher){
        System.out.println("进入TokenWebSessionManager类userRealm方法");
    ...
    public SecurityManager securityManager(DefaultWebSessionManager defaultWebSessionManager, SessionDAO redisSession, UserRealm userRealm){
        System.out.println("进入ShiroAutoConfigurationr类securityManager方法");
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager){
        System.out.println("进入ShiroAutoConfigurationr类shiroFilterFactoryBean方法");
...
//        map.put("authc",new ShiroLoginFilter());
    ...
    public FilterRegistrationBean<DelegatingFilterProxy> filterRegistrationBeanDelegatingFilterProxy(){
        System.out.println("进入ShiroAutoConfigurationr类filterRegistrationBeanDelegatingFilterProxy方法");
    ...
    public AuthorizationAttributeSourceAdvisor authorizationAttributeSourceAdvisor(SecurityManager securityManager) {
        System.out.println("进入ShiroAutoConfigurationr类authorizationAttributeSourceAdvisor方法");
    ...
    public DefaultAdvisorAutoProxyCreator getDefaultAdvisorAutoProxyCreator() {
        System.out.println("进入ShiroAutoConfigurationr类getDefaultAdvisorAutoProxyCreator方法");
    ...
    public IRedisManager  redisManager() {
        System.out.println("进入ShiroAutoConfigurationr类redisManager方法");
